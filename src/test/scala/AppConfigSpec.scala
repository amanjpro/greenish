      ...
      val expected = new AppConfig(
        Seq(
          Group(0, "Group1", Seq(
            ...
            Job(2, "Job5", None, "group1_job5", "/tmp/second_script job5",
              "yyyy-MM-dd-HH", Hourly, 2,
              ZoneId.of("US/Alaska"), 24, 1,
              AlertLevels(0, 1, 2, 3),
              Seq("VAR1" -> "baz", "VAR2" -> "bar", "VAR3" -> "bazooka"),
              ),
            Job(3, "Job7", None, "group1_job7", "/tmp/second_script job7",
          ...
          Group(1, "Group2", Seq(
            ...
            Job(2, "Job6", None, "group2_job6", "/tmp/second_script job6",
              "yyyy-MM-dd-HH-mm", Daily, 1,
              ZoneId.of("US/Samoa"), 270, 0,
